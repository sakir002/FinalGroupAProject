package capt.utilities;
	...
	public class ReadExcelSheet {
		...
		public static Map<String, Map<String, String>> setMapData() throws Exception{
			...
			String path = System.getProperty("user.dir")+"/src/test/resource/Datasheets/AmazonData.xlsx";
		...
		public static String getMapData(String key) throws Exception{
			Map<String, String> m = setMapData().get("AmazonData");
